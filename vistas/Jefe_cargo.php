...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Jefe a Cargo </h1>
                <div class="box-tools pull-right">
                  <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> <a href="../reportes/rptArea.php" target="_blank"><button class="btn btn-info"><i class="fa fa-clipboard"></i> Reporte</button></a>
                </div>
              </div>
              <!-- /.box-header -->
              <!-- centro -->
              ...
              <div class="panel-body" style="height: 400px;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select id="idParticipante" name="idParticipante" class="form-control selectpicker" data-live-search="true" required></select>
                  </div>
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/jefe_cargo.js"></script>
<?php
}
ob_end_flush();
?>
...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Medida de Control </h1>
                <div class="box-tools pull-right">
                  <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> <a href="../reportes/rptMedidaControl.php" target="_blank"><button class="btn btn-info"><i class="fa fa-clipboard"></i> Reporte</button></a>
                </div>
              </div>
              <!-- /.box-header -->
              <!-- centro -->
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/medida_control.js"></script>
<?php
}
ob_end_flush();
?>
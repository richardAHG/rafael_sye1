...
function init() {
  ...
  //Cargamos los items
  $.post("../ajax/gestion_peligrosE.php?op=selectSubActividad", function (r) {
    data = JSON.parse(r);
    options = data.data;
    ...
    $("#subactividad").selectpicker("refresh");
  });

  $.post("../ajax/gestion_peligrosE.php?op=selectTipoAts", function (r) {
    data = JSON.parse(r);
    options = data.data;
  ...
  $.post("../ajax/gestion_peligrosE.php?op=selecPG", function (r) {
    data = JSON.parse(r);
    options = data.data;
  ...
  $.post("../ajax/gestion_peligrosE.php?op=selecRG", function (r) {
    data = JSON.parse(r);
    options = data.data;
  ...
  $.post("../ajax/gestion_peligrosE.php?op=selecMG", function (r) {
    data = JSON.parse(r);
    options = data.data;
  ...
  $("#lGestionPeligrosE").addClass("active");
}
...
//Función Listar
function listar() {
  let url = "../ajax/gestion_peligrosE.php?op=listar";
  ...
  $("#tbllistado")
    .bootstrapTable({
      ...
      columns: [
        ...
        { field: "subactividad", title: "Subactividad" },
...
function guardaryeditar(e) {
  ...
  $.ajax({
    url: "../ajax/gestion_peligrosE.php?op=guardaryeditar",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function mostrar(id) {
  $.post(
    "../ajax/gestion_peligrosE.php?op=mostrar",
    { id: id },
    function (data, status) {
      ...
      $("#subactividad").val(data.tipo_ats_id);
      $("#subactividad").selectpicker("refresh");
...
function desactivar(id) {
  bootbox.confirm(
    ...
    function (result) {
      if (result) {
        $.post(
          "../ajax/gestion_peligrosE.php?op=desactivar",
          { id: id },
          function (e) {
            data = JSON.parse(e);
            bootbox.alert(data.mensaje);
...
function activar(id) {
  bootbox.confirm(
    ...
    function (result) {
      if (result) {
        $.post(
          "../ajax/gestion_peligrosE.php?op=activar",
          { id: id },
          function (e) {
            data = JSON.parse(e);
            bootbox.alert(data.mensaje);
